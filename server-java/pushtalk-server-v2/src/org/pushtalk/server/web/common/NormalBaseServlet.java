...
import org.pushtalk.server.data.h2.TalkService;
...
public class NormalBaseServlet extends HttpServlet {
	...
	protected void responseError(HttpServletResponse response, String s)
			throws IOException {
	...
	protected void responseContent(HttpServletResponse response, String s)
			throws IOException {
		response.setContentType("text/html");
